  ...
  return (
    <div className="header_main">
      ...
      <div className="header_menu">
        ...
        <div className="lanuagies">
          <div className="moon_icon bg-light">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <div className="lang_icon bg-light">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
            ...
            >
              <path
                ...
                stroke-width="1.5"
                d="M10.001 18.333a8.333 8.333 0 1 0 0-16.666 8.333 8.333 0 0 0 0 16.666M1.668 10h16.667"
              ></path>
              <path
                stroke="currentColor"
                stroke-linecap="round"
                stroke-linejoin="round"
                stroke-width="1.5"
                d="M10.001 1.667A12.75 12.75 0 0 1 13.335 10 12.75 12.75 0 0 1 10 18.333 12.75 12.75 0 0 1 6.668 10a12.75 12.75 0 0 1 3.333-8.333"
              ></path>
            </svg>
          </div>
        </div>
        <div className="login_signup hide_class d-flex">
